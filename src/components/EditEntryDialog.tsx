  ...
  useEffect(() => {
    if (open) {
      ...
      setFormData({
        ...
        sdOpenA: (entry as any).sdOpenA || '',
        ogCloseA: entry.ogCloseA || '',
        sdCloseA: (entry as any).sdCloseA || '',
        notes: entry.notes || ''
      });
      ...
      setSelectedDates({
        ...
        dropdown7Date: entry.dropdown7Date ? new Date(entry.dropdown7Date) : null,
        dropdown8Date: entry.dropdown8Date ? new Date(entry.dropdown8Date) : null,
            ...
            <div className="space-y-4 border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Select 
                      ...
                      onValueChange={(value) => setDropdowns(prev => ({ ...prev, dropdown5Main: value }))}
                    >
                      <SelectTrigger className="text-lg font-bold" style={{ backgroundColor: dropdowns.dropdown5Main ? '#dcfce7' : '#ffe3e2' }}>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => setDropdowns(prev => ({ ...prev, dropdown5Sub: value }))}
                    >
                      <SelectTrigger className="text-lg font-bold" style={{ backgroundColor: dropdowns.dropdown5Sub ? '#dcfce7' : '#ffe3e2' }}>
                        <SelectValue placeholder="Select" />
                      </SelectTrigger>
                      <SelectContent className="bg-background z-[100]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Select value={dropdowns.candleMain} onValueChange={(value) => setDropdowns(prev => ({ ...prev, candleMain: value }))}>
                      ...
                      <SelectContent className="bg-card z-[100]">
                        {Array.from({ length: 25 }, (_, i) => i + 1).map(num => (
                          <SelectItem key={num} value={`CANDLE ${num}`} className="text-lg font-bold">CANDLE {num}</SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                    <Select value={dropdowns.candleSub} onValueChange={(value) => setDropdowns(prev => ({ ...prev, candleSub: value }))}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <Label className="text-sm font-bold">DIRECTION A</Label>
                  <Select 
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-bold">DIRECTION B</Label>
                  <Select 
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-bold">DIRECTION C</Label>
                  <Select 
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-bold">DIRECTION D</Label>
                  <Select 
              ...
              {/* OPEN and CLOSE with SD dropdowns */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-bold">CLOSE</Label>
                  <div className="grid grid-cols-2 gap-2">
                    <Select 
