                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {entry.dropdown7 && (
                    <div className="px-3 py-2 rounded bg-amber-50 border border-amber-200">
                      <div className="text-sm font-bold text-amber-700 mb-1">YEARLY OPEN</div>
                      <span className="text-lg font-bold">{entry.dropdown7}</span>
                      {entry.dropdown7Date && (
                        <div className="text-xs text-amber-600 mt-1">
                          {format(new Date(entry.dropdown7Date), "d/M/yyyy")}
                        </div>
                      )}
                    </div>
                  )}
                  {entry.dropdown8 && (
                    <div className="px-3 py-2 rounded bg-lime-50 border border-lime-200">
                      <div className="text-sm font-bold text-lime-700 mb-1">YEARLY CLOSE</div>
                      <span className="text-lg font-bold">{entry.dropdown8}</span>
                      {entry.dropdown8Date && (
                        <div className="text-xs text-lime-600 mt-1">
                          {format(new Date(entry.dropdown8Date), "d/M/yyyy")}
                        </div>
                      )}
                    </div>
                  )}
